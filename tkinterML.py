...
import independentComponents as Comp

from _tkinter import TclError

altanertiveNames={"betterbutton":"BetterButton","div":"Frame","optionbutton":"OptionButton"}
class MyHTMLParser(HTMLParser):
    ...
    def handle_starttag(self, tag, attrs):#
        ...
        if tag.lower()=="window":
            ...
            try:
                if tag in altanertiveNames:
                    print("innames",tag)
                    tag=altanertiveNames[tag]
                else :tag=tag.capitalize()
    ...
    def createElement(self,tag,kwwargs,id=None):
        ...
        if styleart:
            ...
            try:
                print(name,tag)
                print("self.namel['"+name+"']="+tag + "(master=self.namel['"+self.tagStack[-1]+"'],name='"+name+"',"+styleart+")")
                print("self.namel['"+name+"']="+tag + "(master=self.namel['"+self.tagStack[-1]+"'],name='"+name+"',"+styleart+")")
            ...
            exec("self.namel['"+name+"']="+tag.capitalize() + "(self.namel['"+self.tagStack[-1]+"'],name='"+name+"' )")
